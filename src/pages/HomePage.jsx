      ...
      <div className='flex  px-10 w-full '>
        <div className='flex flex-col gap-10 w-1/2'>
          ...
          <div className='flex gap-6'>
            <NavLink to="/courses">
              <button className=' bg-green-500 text-white rounded-full px-3 py-3 hover:text-green-500 hover:bg-white outline outline-green-600 transition-all duration-300 text-md font-semibold'>View Courses</button>
            </NavLink>
        ...
        <div className=' grid grid-cols-2 w-1/2 text-center gap-y-10 gap-x-5 text-white'>
